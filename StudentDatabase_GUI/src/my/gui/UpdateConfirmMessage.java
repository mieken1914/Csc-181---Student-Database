...
public class UpdateConfirmMessage extends javax.swing.JFrame {

    /**
     * Creates new form UpdateConfirmMessage
     */
    public UpdateConfirmMessage(Student_Info passed_acct) {
    ...
    public static void main(String args[],Student_Info passed_acct) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateConfirmMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateConfirmMessage(passed_acct).setVisible(true);
            }
        });
    }
