...
public class DeleteConfirmMessage extends javax.swing.JFrame {

    /**
     * Creates new form DeleteConfirmMessage
     */
    public DeleteConfirmMessage(Student_Info passed_acct) {
    ...
    public static void main(String args[],Student_Info passed_acct) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteConfirmMessage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteConfirmMessage(passed_acct).setVisible(true);
            }
        });
    }
